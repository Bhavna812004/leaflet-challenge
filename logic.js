...
// define function to create circle radius bassed on the magnitude 
  function radiusSize(mag) {
    return mag * 10000;
  }
//define funtion to set the circle color
...
//Sending earthquakes layer to the create Map 
  function createMap(earthquakes) {
// define streetmap, darkmap and basemap layers
